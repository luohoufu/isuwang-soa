...
import com.isuwang.route.RouteEngine.RouteConfig;
...
public final class RouteEngineFactory {
    ...
    public static synchronized RouteEngine getRouteEngine() {
        ...
        try {
            Class<?> engineImpl = Class.forName("com.isuwang.soa.route.RouteEngineImpl");
    ...
    static class NoopRouteConfig implements RouteConfig {
