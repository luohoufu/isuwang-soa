 ...
 *
 **/
public class TGlobalTransaction {
     ...
     *
     **/
    private com.isuwang.soa.transaction.api.domain.TGlobalTransactionsStatus status;

    public com.isuwang.soa.transaction.api.domain.TGlobalTransactionsStatus getStatus() {
        return this.status;
    }

    public void setStatus(com.isuwang.soa.transaction.api.domain.TGlobalTransactionsStatus status) {
        this.status = status;
    }
