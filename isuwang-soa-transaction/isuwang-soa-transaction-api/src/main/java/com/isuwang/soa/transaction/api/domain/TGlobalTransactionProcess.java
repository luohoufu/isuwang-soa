...
public class TGlobalTransactionProcess {
     ...
     *
     **/
    private com.isuwang.soa.transaction.api.domain.TGlobalTransactionProcessStatus status;

    public com.isuwang.soa.transaction.api.domain.TGlobalTransactionProcessStatus getStatus() {
        return this.status;
    }

    public void setStatus(com.isuwang.soa.transaction.api.domain.TGlobalTransactionProcessStatus status) {
        this.status = status;
    }
     ...
     *
     **/
    private com.isuwang.soa.transaction.api.domain.TGlobalTransactionProcessExpectedStatus expectedStatus;

    public com.isuwang.soa.transaction.api.domain.TGlobalTransactionProcessExpectedStatus getExpectedStatus() {
        return this.expectedStatus;
    }

    public void setExpectedStatus(com.isuwang.soa.transaction.api.domain.TGlobalTransactionProcessExpectedStatus expectedStatus) {
