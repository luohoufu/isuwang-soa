...
public class SoaSystemEnvProperties {
    ...
    public static final boolean SOA_SERVICE_HOST_ISCONFIG = get(KEY_SOA_ZOOKEEPER_HOST) != null;
    ...
    public static final boolean SOA_TRANSACTIONAL_ENABLE = Boolean.valueOf(get(KEY_SOA_TRANSACTIONAL_ENABLE, "false"));
