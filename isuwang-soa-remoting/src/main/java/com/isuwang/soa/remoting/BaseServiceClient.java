...
import com.isuwang.soa.remoting.filter.xml.SoaFilter;
import com.isuwang.soa.remoting.filter.xml.SoaFilters;
import com.isuwang.soa.remoting.netty.IdleConnectionManager;
...
public class BaseServiceClient {
    ...
    protected <REQ, RESP> RESP sendBase(REQ request, RESP response, TBeanSerializer<REQ> requestSerializer, TBeanSerializer<RESP> responseSerializer) throws TException {
        ...
        stubFilterChain.setAttribute(SendMessageFilter.ATTR_KEY_SENDMESSAGE, (SendMessageFilter.SendMessageAction) (chain) -> {
            ...
            com.isuwang.soa.remoting.netty.SoaConnection conn = com.isuwang.soa.remoting.netty.SoaConnectionPool.getInstance().getConnection();
