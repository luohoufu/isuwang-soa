...
JVM_OPTS="-Xms256m -Xmx1024m -Xloggc:$logdir/gc.log -XX:+PrintGCDateStamps -XX:+PrintGCDetails -XX:+PrintGC -XX:+HeapDumpOnOutOfMemoryError"
DEBUG_OPTS=""
...
nohup java $JVM_OPTS $SOA_BASE $DEBUG_OPTS $USER_OPTS -cp ./dapeng-bootstrap.jar com.isuwang.dapeng.bootstrap.Bootstrap >> $logdir/catalina.out 2>&1 &
echo $! > $logdir/pid.txt